...
<div class="full-poisk">
    <div class="class_buttons">
        <button type="button" class="class_btn <?= $classFilter == '10' ? 'active' : '' ?>" data-class="10">10 класс</button>
        <button type="button" class="class_btn <?= $classFilter == '11' ? 'active' : '' ?>" data-class="11">11 класс</button>
