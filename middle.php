...
$tables = [
    'movies' => [
        'table' => 'middle_movies',
        'view_page' => 'middle_view.php'
    ],
    'performances' => [
        'table' => 'middle_performances',
        'view_page' => 'middle_view_performance.php'
    ],
    'poems' => [
        'table' => 'middle_poems',
        'view_page' => 'middle_view_poem.php'
    ],
    'audio' => [
        'table' => 'middle_audiobooks',
        'view_page' => 'middle_view_audiobooks.php'
    ]
];
...
<div class="full-poisk">
    <div class="class_buttons">
        <button type="button" class="class_btn <?= $classFilter == '5' ? 'active' : '' ?>" data-class="5">5 класс</button>
        <button type="button" class="class_btn <?= $classFilter == '6' ? 'active' : '' ?>" data-class="6">6 класс</button>
        <button type="button" class="class_btn <?= $classFilter == '7' ? 'active' : '' ?>" data-class="7">7 класс</button>
        <button type="button" class="class_btn <?= $classFilter == '8' ? 'active' : '' ?>" data-class="8">8 класс</button>
        <button type="button" class="class_btn <?= $classFilter == '9' ? 'active' : '' ?>" data-class="9">9 класс</button>
